...
SimulationRequest newSimulationRequest(std::string npop, std::string prevalence,
	...
	//TODO: dummyproofing
	request.npop = std::stoi(npop);
	request.prevalence = std::stod(prevalence);
	request.nsnp = std::stoi(nsnp);
	request.me = std::stod(me);
	request.sde = std::stod(sde);

	request.oddsRatio = std::stod(oddsRatio);
	request.upperMAF = std::stod(upperMAF);
	request.lowerMAF = std::stod(lowerMAF);
